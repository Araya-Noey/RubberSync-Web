...
- หน้าเว็บอยู่ที่ `Frontend/public` และ API อยู่ที่ `Backend/server.js`
- ข้อมูลผู้ใช้ / คำขอ / ประกาศ / การจ่ายเงิน บันทึกลง `Backend/data/db.json`
...
2. แตก ZIP
3. เข้าโฟลเดอร์หลักที่เห็น `Frontend`, `Backend`, `package.json`, `START_WEB.bat`
...
## ข้อมูลที่บันทึก
- `Backend/data/db.json` ฐานข้อมูลแบบ JSON สำหรับระบบนี้
- `Backend/uploads/` รูปใบเสร็จและสลิปที่อัปโหลด
